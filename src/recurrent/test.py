...
expressions = [
    ...
    (
        ...
        dict(freq="daily", interval=1, count=4),
        "daily for 4 times",
    ),
    (
        "every day for 5 occurrences",
        dict(freq="daily", interval=1, count=5),
        "daily for 5 times",
    ),
    ...
    (
        "daily except for tomorrow",
        dict(freq="daily", interval=1, exdate=[TOMORROW.date()]),
        "daily except on Sat Jan 2, 2010",
    ),
    (
        "daily except on weekends",
        dict(freq="daily", interval=1, exrule="BYDAY=SA,SU;INTERVAL=1;FREQ=WEEKLY"),
        "daily except weekends",
    ),
    (
        "daily except in may",
        dict(freq="daily", interval=1, exdate=[[5, NOW.year]]),
        "daily except in May",
    ),
    (
        "daily except in may %s" % NOW.year,
        dict(freq="daily", interval=1, exdate=[[5, NOW.year]]),
        "daily except in May",
    ),
    ...
    (
        "every other weekend",
        dict(freq="weekly", interval=2, byday="SA,SU"),
        "every other week on weekend",
    ),
    ("every other week on weekend", dict(freq="weekly", interval=2, byday="SA,SU")),
    (
        "every 4 weekends",
        dict(freq="weekly", interval=4, byday="SA,SU"),
        "every 4 weeks on weekend",
    ),
    (
        "every 4 weekends except in july and sept",
        dict(
            freq="weekly",
            interval=4,
            byday="SA,SU",
            exdate=[[7, NOW.year], [9, NOW.year]],
        ),
        "every 4 weeks on weekend except in Jul and Sep",
    ),
    (
        "every 4 weeks on weekends",
        dict(freq="weekly", interval=4, byday="SA,SU"),
        "every 4 weeks on weekend",
    ),
    (
        "every 4th week on weekends",
        dict(freq="weekly", interval=4, byday="SA,SU"),
        "every 4 weeks on weekend",
    ),
    ...
    (
        "every weekday",
        dict(freq="weekly", interval=1, byday="MO,TU,WE,TH,FR"),
        "weekdays",
    ),
    (
        "tuesdays and thursdays",
        dict(freq="weekly", interval=1, byday="TU,TH"),
        "every Tue and Thu",
    ),
    ("weekly on wednesdays", dict(freq="weekly", interval=1, byday="WE"), "every Wed"),
    (
        "weekly on wednesdays and fridays",
        dict(freq="weekly", interval=1, byday="WE,FR"),
        "every Wed and Fri",
    ),
    (
        "every sunday and saturday",
        dict(freq="weekly", interval=1, byday="SU,SA"),
        "every Sun and Sat",
    ),
    ...
    (
        ...
        dict(freq="weekly", interval=1, byday="WE"),
        "every Wed",
    ),
    (
        "every other week on mon",
        dict(freq="weekly", interval=2, byday="MO"),
        "every other week on Mon",
    ),
    (
        "every 3 weeks on mon",
        dict(freq="weekly", interval=3, byday="MO"),
        "every 3 weeks on Mon",
    ),
    (
        "every other week on mon and fri",
        dict(freq="weekly", interval=2, byday="MO,FR"),
        "every other week on Mon and Fri",
    ),
    (
        "every 3 weeks on mon and fri",
        dict(freq="weekly", interval=3, byday="MO,FR"),
        "every 3 weeks on Mon and Fri",
    ),
    ("every 3 days", dict(freq="daily", interval=3)),
    (
        "every 2nd of the month",
        dict(freq="monthly", interval=1, bymonthday="2"),
        "2nd of every month",
    ),  # Issue #16
    (
        "every 4th of the month",
        dict(freq="monthly", interval=1, bymonthday="4"),
        "4th of every month",
    ),
    ...
    (
        ...
        dict(freq="monthly", interval=2, bymonthday="4"),
        "4th of every other month",
    ),
    (
        "the 4th of every 3 months",
        dict(freq="monthly", interval=3, bymonthday="4"),
        "4th of every 3 months",
    ),
    (
    ...
    (
        "the 4th of every 3rd month",
        dict(freq="monthly", interval=3, bymonthday="4"),
        "4th of every 3 months",
    ),
    (
        "every 3rd month on the 4th",
        dict(freq="monthly", interval=3, bymonthday="4"),
        "4th of every 3 months",
    ),
    (
        "every 4th and 10th of the month",
        dict(freq="monthly", interval=1, bymonthday="4,10"),
        "4th and 10th of every month",
    ),
    (
        "every 4th and 10th of the month up to 7x",
        dict(freq="monthly", interval=1, bymonthday="4,10", count=7),
        "4th and 10th of every month for 7 times",
    ),
    (
        "every first friday of the month",
        dict(freq="monthly", interval=1, byday="1FR"),
        "1st Fri of every month",
    ),
    (
        "monthly on fri",
        dict(freq="monthly", interval=1, byday="FR"),
        "Fri of every month",
    ),
    (
        "monthly on tue and fri",
        dict(freq="monthly", interval=1, byday="TU,FR"),
        "Tue and Fri of every month",
    ),
    (
        "monthly on the first and last instance of tue and fri",
        dict(freq="monthly", interval=1, byday="TU,FR", bysetpos="1,-1"),
        "for the 1st and last instance of Tue and Fri of every month",
    ),
    (
    ...
    (
        ...
        dict(freq="monthly", interval=1, byday="-2FR"),
        "2nd to the last Fri of every month",
    ),  # Issue #18
    (
        "2nd and last fri of each month",
        dict(freq="monthly", interval=1, byday="2FR,-1FR"),
        "2nd and last Fri of every month",
    ),  # Issue #18
    (
        "2nd and 2nd to the last fri of each month",
        dict(freq="monthly", interval=1, byday="2FR,-2FR"),
        "2nd and 2nd to the last Fri of every month",
    ),  # Issue #18
    (
        "2nd and last fridays of each month",
        dict(freq="monthly", interval=1, byday="2FR,-1FR"),
        "2nd and last Fri of every month",
    ),  # Issue #18
    (
        "first day of each month",
        dict(freq="monthly", interval=1, bymonthday="1"),
        "1st of every month",
    ),  # Issue #18
    (
    ...
    (
        "every month at the begin",
        dict(freq="monthly", interval=1, bymonthday="1"),
        "1st of every month",
    ),  # Issue #12
    (
        "every month at the start",
        dict(freq="monthly", interval=1, bymonthday="1"),
        "1st of every month",
    ),  # Issue #12
    (
    ...
    (
        ...
        dict(freq="monthly", interval=1, bymonthday="-2"),
        "2nd to the last of every month",
    ),  # Issue #18
    (
    ...
    (
        ...
        dict(freq="monthly", interval=2, byday="1FR"),
        "1st Fri of every other month",
    ),
    (
        "first friday of every 3 months",
        dict(freq="monthly", interval=3, byday="1FR"),
        "1st Fri of every 3 months",
    ),
    (
        "first friday of every 3rd month",
        dict(freq="monthly", interval=3, byday="1FR"),
        "1st Fri of every 3 months",
    ),
    (
        "first and third friday of each month",
        dict(freq="monthly", interval=1, byday="1FR,3FR"),
        "1st and 3rd Fri of every month",
    ),
    (
        "first, second, and third friday of each month",
        dict(freq="monthly", interval=1, byday="1FR,2FR,3FR"),
        "1st and 2nd and 3rd Fri of every month",
    ),
    (
        "first and third friday and second tuesday of each month",
        dict(freq="monthly", interval=1, byday="1FR,3FR,2TU"),
        "1st and 3rd Fri and 2nd Tue of every month",
    ),
    (
        "yearly on the fourth thursday in november",
        dict(freq="yearly", interval=1, byday="4TH", bymonth="11"),
    ...
    (
        ...
        dict(freq="yearly", interval=1, bymonthday="25", bymonth="12"),
        "every Dec 25th",
    ),
    (
        "every year on december 21st and 31st",
        dict(freq="yearly", interval=1, bymonthday="21,31", bymonth="12"),
        "every Dec 21st and 31st",
    ),
    (
        "every year on december 31st",
        dict(freq="yearly", interval=1, bymonthday="31", bymonth="12"),
        "every Dec 31st",
    ),
    (
        "every year on the 31st",
        dict(freq="yearly", interval=1, byyearday="31"),
    ...
    (
        "every july 4th",
        dict(freq="yearly", interval=1, bymonthday="4", bymonth="7"),
        "every Jul 4th",
    ),
    (
        "every aug 30",
        dict(freq="yearly", interval=1, bymonthday="30", bymonth="8"),
        "every Aug 30th",
    ),  # Issue #15
    (
        "every aug 20 and 30",
        dict(freq="yearly", interval=1, bymonthday="20,30", bymonth="8"),
        "every Aug 20th and 30th",
    ),  # Issue #15
    (
    ...
    (
        ...
        dict(freq="yearly", interval=1, byweekno="12"),
        "every year in week 12",
    ),
    (
        "every 3 years on Fri in week 12",
        dict(freq="yearly", interval=3, byday="FR", byweekno="12"),
        "every 3 years on Fri in week 12",
    ),
    (
        "every Fri in week 12",
        dict(freq="yearly", interval=1, byday="FR", byweekno="12"),
        "every Fri in week 12",
    ),
    (
        "every Fri in week 12 and 14",
        dict(freq="yearly", interval=1, byday="FR", byweekno="12,14"),
        "every Fri in week 12 and 14",
    ),
    (
    ...
    (
        ...
        "daily from Thu Apr 1, 2010 to Tue Mar 1, 2011",
    ),
    (
    ...
    (
        ...
        "daily starting Wed Mar 3, 2010 except on Sat Mar 6, 2010 and Mon Mar 8, 2010",
    ),
    (
    ...
    (
        ...
        "daily from Wed Mar 3, 2010 to Mon Apr 5, 2010",
    ),
    (
    ...
    (
        ...
        "every Wed until Mon Nov 1, 2010",
    ),
    (
        "every wed until november except in march and may",
        dict(
            until="%d1101" % NOW.year,
            freq="weekly",
            interval=1,
            byday="WE",
            exdate=[[3, NOW.year], [5, NOW.year]],
        ),
        "every Wed until Mon Nov 1, 2010 except in Mar and May",
    ),
    (
        ...
        dict(
            ...
            interval=1,
            byday="WE",
            exdate=[[3, NOW.year + 1], [5, NOW.year + 1]],
        ),
    ...
    (
        ...
        dict(
            ...
            interval=1,
            byday="WE",
            exdate=[[12, NOW.year], [5, NOW.year + 1]],
        ),
    ...
    (
        ...
        dict(
            ...
            interval=1,
            byday="WE",
            exdate=[[12, NOW.year], [3, NOW.year + 1], [5, NOW.year + 1]],
        ),
    ...
    (
        "every 2 hours twice",
        dict(freq="hourly", interval=2, count=2),
        "every other hour twice",
    ),
    (
    ...
    (
        ...
        dict(
            freq="hourly",
            interval=8,
            exrule="BYHOUR=0;BYMINUTE=0;INTERVAL=1;FREQ=DAILY",
        ),
        "every 8 hours except daily at 12am",
    ),
    (
        ...
        dict(
            freq="hourly",
            interval=12,
            exdate=[datetime.date(NOW.year, 1, 2), datetime.date(NOW.year, 1, 3)],
        ),
    ...
    (
        ...
        dict(
            freq="hourly", interval=8, exdate=[TOMORROW + datetime.timedelta(hours=8)]
        ),
    ...
    (
        "every 20 min",
        dict(freq="minutely", interval=20),
        "every 20 minutes",
    ),  # Issue #3
    (
        "every 45 mins",
        dict(freq="minutely", interval=45),
        "every 45 minutes",
    ),  # Issue #3
    # with times
    (
        "daily at 12am",
        dict(freq="daily", interval=1, byhour="0", byminute="0"),
    ),  # Issue #14
    (
        "daily at 12a",
        dict(freq="daily", interval=1, byhour="0", byminute="0"),
    ...
    (
        "daily at 3am 10x",
        dict(freq="daily", interval=1, byhour="3", byminute="0", count=10),
        "daily at 3am for 10 times",
    ),
    (
        "daily at 3:00am",
        dict(freq="daily", interval=1, byhour="3", byminute="0"),
        "daily at 3am",
    ),  # Issue #17
    (
        "daily at 3:01am",
        dict(freq="daily", interval=1, byhour="3", byminute="1"),
    ),  # Issue #17
    (
        "daily at 12pm",
        dict(freq="daily", interval=1, byhour="12", byminute="0"),
    ),  # Issue #14
    (
        "daily at 12p",
        dict(freq="daily", interval=1, byhour="12", byminute="0"),
    ...
    (
        "daily at 3 pm",
        dict(freq="daily", interval=1, byhour="15", byminute="0"),
        "daily at 3pm",
    ),  # Issue #13
    (
        "daily at 3p",
    ...
    (
        "daily at 3:01pm",
        dict(freq="daily", interval=1, byhour="15", byminute="1"),
    ),  # Issue #17
    (
    ...
    (
        ...
        dict(freq="weekly", interval=2, byday="MO,TU,SA,SU"),
        "every other week on Mon and Tue and weekend",
    ),
    (
        "each week on saturday thru tuesday",
        dict(freq="weekly", interval=1, byday="SA,SU,MO,TU"),
        "every weekend and Mon and Tue",
    ),
    (
        "each week on tuesday-saturday",
        dict(freq="weekly", interval=1, byday="TU,WE,TH,FR,SA"),
        "every Tue and Wed and Thu and Fri and Sat",
    ),
    (
        "each week on tuesday-tue",
        dict(freq="weekly", interval=1, byday="TU"),
        "every Tue",
    ),
    ("tuesdays-tue", dict(freq="weekly", interval=1, byday="TU"), "every Tue"),
    (
        "saturdays through tuesdays",
        dict(freq="weekly", interval=1, byday="MO,TU,SA,SU"),
        "every Mon and Tue and weekend",
    ),
    (
        "every thursday for the next three weeks",
        dict(freq="weekly", interval=1, byday="TH", until="%d0122" % NOW.year),
        "every Thu until Fri Jan 22, 2010",
    ),
    (
        "every mon and fri for the next month",
        dict(freq="weekly", interval=1, byday="MO,FR", until="%d0201" % NOW.year),
        "every Mon and Fri until Mon Feb 1, 2010",
    ),
    (
        "every sat for 2 months",
        dict(freq="weekly", interval=1, byday="SA", until="%d0301" % NOW.year),
        "every Sat until Mon Mar 1, 2010",
    ),
    (
        "every sat for up to 2 months",
        dict(freq="weekly", interval=1, byday="SA", until="%d0301" % NOW.year),
        "every Sat until Mon Mar 1, 2010",
    ),
    (
        "every other sat for up to 14 months",
        dict(freq="weekly", interval=2, byday="SA", until="%d0301" % (NOW.year + 1)),
        "every other week on Sat until Tue Mar 1, 2011",
    ),
    (
        "every other fri for the next year",
        dict(freq="weekly", interval=2, byday="FR", until="%d0101" % (NOW.year + 1)),
        "every other week on Fri until Sat Jan 1, 2011",
    ),
    (
        "every 5th fri for the next 3 years",
        dict(freq="weekly", interval=5, byday="FR", until="%d0101" % (NOW.year + 3)),
        "every 5 weeks on Fri until Tue Jan 1, 2013",
    ),
    # non-recurring
    ...
    (
        "this sunday",
        (NOW + datetime.timedelta(days=(6 - NOW.weekday()) % 7)).date(),
        "Sun Jan 3, 2010 9am",
    ),
    (
    ...
    (
        "tomorrow",
        datetime.date(NOW.year, NOW.month, NOW.day + 1),
        "Sat Jan 2, 2010 9am",
    ),
    ...
    (
        ...
        datetime.datetime(NOW.year, 4, 15, 10),
        "Thu Apr 15, 2010 10am",
    ),
    ...
    (
        ...
        dict(
            freq="daily",
            interval=1,
            exdate=[datetime.date(NOW.year, 6, 23), datetime.date(NOW.year, 7, 4)],
        ),
    ...
    (
        ...
        dict(
            ...
            interval=1,
            byday="MO",
            exrule="BYDAY=2MO;BYMONTH=3;INTERVAL=1;FREQ=YEARLY",
        ),
        "every Mon except every 2nd Mon in Mar",
    ),
    (
        "fridays twice",
        dict(freq="weekly", interval=1, byday="FR", count=2),
        "every Fri twice",
    ),
    (
        "fridays 3x",
        dict(freq="weekly", interval=1, byday="FR", count=3),
        "every Fri for 3 times",
    ),
    (
        "every other friday for 5 times",
        dict(freq="weekly", interval=2, byday="FR", count=5),
        "every other week on Fri for 5 times",
    ),
    (
    ...
    (
        ...
        dict(
            freq="weekly", interval=1, byday="MO,TU,WE", until="%d0101" % (NOW.year + 1)
        ),
...
time_expressions = [
    (
        ...
        datetime.datetime(NOW.year, 3, 3, 0, 15),
        "Wed Mar 3, 2010 12:15am",
    ),
    (
        "8/1/2100 at 12:15am",
        datetime.datetime(2100, 8, 1, 0, 15),
        "Sun Aug 1, 2100 12:15am",
    ),  # Issue #17
    (
        "8/1/2100 at 1am",
        datetime.datetime(2100, 8, 1, 1, 0),
        "Sun Aug 1, 2100 1am",
    ),  # Issue #17
    (
        "8/1/2100 at 1:01",
        datetime.datetime(2100, 8, 1, 13, 1),
        "Sun Aug 1, 2100 1:01pm",
    ),  # Issue #17
    (
        "8/1/2100 at 1:02am",
        datetime.datetime(2100, 8, 1, 1, 2),
        "Sun Aug 1, 2100 1:02am",
    ),  # Issue #17
    (
        "8/1/2100 at 12pm",
        datetime.datetime(2100, 8, 1, 12, 0),
        "Sun Aug 1, 2100 12pm",
    ),  # Issue #17
    (
        "8/1/2100 at 12p",
    ...
    (
        "8/1/2100 at 1 pm",
        datetime.datetime(2100, 8, 1, 13, 0),
        "Sun Aug 1, 2100 1pm",
    ),  # Issue #17
    (
        "at 1 pm on 8/1/2100",
    ...
    (
        "8/1/2100 at 2:01pm",
        datetime.datetime(2100, 8, 1, 14, 1),
        "Sun Aug 1, 2100 2:01pm",
    ),  # Issue #17
    ...
    (
        "sunday at 2",
        (NOW + datetime.timedelta(days=(6 - NOW.weekday()) % 7)).replace(hour=14),
        "Sun Jan 3, 2010 2pm",
    ),
    (
        "at 9am on the 2nd fri in feb",
        datetime.datetime(NOW.year, 2, 12, 9),
        "Fri Feb 12, 2010 9am",
    ),
    (
        "2nd fri in feb at 9",
...
non_dt_expressions = (
    ...
    (
        ...
        "Mon Jan 4, 2010",
    ),  # Parses like 2nd of the week
    (
        "2nd month",
        datetime.datetime(NOW.year, 1, 2),
        "Sat Jan 2, 2010",
    ),  # Parses like 2nd of the month
...
extra_expressions = (  # We test these exactly, not in phrases
    (
        "1 oclock on 8/1/2100",
        datetime.datetime(2100, 8, 1, 13, 0),
        "Sun Aug 1, 2100 1pm",
    ),  # Issue #17
    (
        "1 o'clock on 8/1/2100",
        datetime.datetime(2100, 8, 1, 13, 0),
        "Sun Aug 1, 2100 1pm",
    ),
    (
...
embedded_expressions = (
    [fixup_default("im available " + s, s, *v) for s, *v in expressions]
    + [fixup_default(s + " would work best for me", s, *v) for s, *v in expressions]
    + [
        fixup_default("remind me to move car " + s + " would work best for me", s, *v)
        for s, *v in expressions
    ]
)
...
class ParseTest(unittest.TestCase):
    ...
    def test_format_errors(self):
        ...
        self.assertEqual(
            date.format("RRULE:FREQ=WEEKLY"), "RRULE:FREQ=WEEKLY"
        )  # No BYDAY
        self.assertEqual(
            date.format("RRULE:FREQ=WEEKLY;BYDAY=XX"), "RRULE:FREQ=WEEKLY;BYDAY=XX"
        )  # Bad BYDAY
        self.assertEqual(
            date.format("RRULE:FREQ=MONTHLY"), "RRULE:FREQ=MONTHLY"
        )  # No BYMONTHDAY or BYDAY
        self.assertEqual(
            date.format("RRULE:FREQ=YEARLY"), "RRULE:FREQ=YEARLY"
        )  # No BYMONTHDAY or BYDAY or BYMONTH
    ...
    def test_format_plus(self):
        ...
        self.assertEqual(
            date.format(datetime.datetime(2000, 1, 2, 3, 4, 5)),
    ...
    def test_(self):
        ...
        if known_failure:
            raise AssertionError(
                "Known failure passed:", expected_params, string
            )  # pragma nocover
        self.maxDiff = 1000
        if de is not None:
...
for i, expr in enumerate(expressions):
    ...
    setattr(
        ParseTest,
        "test_%03d_%s" % (i, string.replace(" ", "_")),
        tst_expression(string, params, de),
    )
